...
sub _GetWebserviceHistoryDetails {
    ...
    # dump config
    $LogData->{Config} = $Kernel::OM->Get('Kernel::System::YAML')->Dump( Data => $LogData->{Config} );
...
sub _ExportWebserviceHistory {
    ...
    my $YAMLContent = $Kernel::OM->Get('Kernel::System::YAML')->Dump( Data => $WebserviceHistoryData->{Config} );
