...
$Selenium->RunTest(
    sub {
        ...
        $Selenium->find_element( "#EditDialog select option[value='XAxisPriorityIDs']", 'css' )->click();
        $Selenium->find_element( "#DialogButton1",                                     'css' )->click();

        # check Y-axis configuration dialog
        $Selenium->find_element( ".EditYAxis",                                     'css' )->click();
        $Selenium->find_element( "#EditDialog a.RemoveButton i",                   'css' )->click();
        $Selenium->find_element( "#EditDialog select option[value='YAxisStateIDs']", 'css' )->click();
        $Selenium->find_element( "#DialogButton1",                                 'css' )->click();
