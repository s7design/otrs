...
$Selenium->RunTest(
    sub {
        ...
        my $ArticleID     = $TicketObject->ArticleCreate(
            ...
            Subject     => $Subject,
            Body =>
                "'maybe $MinCharString in an abbreviation' this is string with more then 30 characters $MaxCharString",
        ...
        # run console comand to create initial index search
        system("perl bin/otrs.Console.pl Maint::Ticket::FulltextIndexRebuild");
        ...
        # try to search fulltext with string more then 30 characters
