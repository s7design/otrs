# --
# AdminSysConfig.t - frontend tests for AdminSysConfig
...
$Selenium->RunTest(
    sub {
        ...
        # e.g Core::PerformanceLog, Core::Ticket and Core::TicketWatcher
        ...
        for my $SysConfSearch (
            qw (PerformanceLog Ticket TicketWatcher)
            )
        {
            $Self->True(
        ...
        $Selenium->find_element("//select[\@name='Ticket::NewArticleIgnoreSystemSender']/option[2]")->click();
