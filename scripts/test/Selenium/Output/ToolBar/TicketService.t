...
$Selenium->RunTest(
    sub {
        ...
        # toolbar icon should be removed, see bug#12269 (https://bugs.otrs.org/show_bug.cgi?id=12669).
        ...
        $Self->True(
            ...
            "ToolBar icon 'Ticket in my Services' is removed when agent dont have rw access to ticket",
        );
        ...
        $Self->True(
            ...
            "ToolBar icon 'Ticket in my Services' is shown when agent dont have rw access to ticket and settings 'ViewAllPossibleTickets' is enabled",
        );
        ...
        $Self->True(
            $Success,
            "Personal_service connection is delted",
        );
