    ...
    TargetNS.Init = function () {
        ...
        (function(doc, win) {
            var isIFrame = (win.top.location.href !== win.location.href),
                ...
                ResponsiveCSS,
                Index,
                CSSFiles = Core.Config.Get('AgentCSSFiles');
                ...
                if (((!isIFrame && !isPopup) || (isIFrame && isPopup)) && (!localStorage.getItem("DesktopMode") || parseInt(localStorage.getItem("DesktopMode"), 10) <= 0)) {
                    for (Index in CSSFiles) {
                        ...
                        ResponsiveCSS.setAttribute(
                            "href",
                            Core.Config.Get('FrontendWebPath') + 'skins/Agent/' + CSSFiles[Index].Skin + '/' + CSSFiles[Index].CSSDirectory + '/' + CSSFiles[Index].Filename
                        );
