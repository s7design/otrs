...
Core.Agent.Dashboard = (function (TargetNS) {
     ...
     * @param {Array} MonthNames - Array containing the localized strings for each month.
     * @param {Array} MonthNamesShort - Array containing the localized strings for each month on shorth format.
     * @param {Array} DayNames - Array containing the localized strings for each week day.
     * @param {Array} DayNamesShort - Array containing the localized strings for each week day on short format.
     * @param {Array} ButtonText - Array containing the localized strings for each week day on short format.
     * @param {String} ButtonText.today - Localized string for the word "Today".
     * @param {String} ButtonText.month - Localized string for the word "month".
     * @param {String} ButtonText.week - Localized string for the word "week".
     * @param {String} ButtonText.day - Localized string for the word "day".
